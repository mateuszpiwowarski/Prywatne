...
void drawBatteryIcon() {
    uint8_t batteryWidth = 10;
    uint8_t batteryHeight = 5;
    uint8_t topLeftX = SSD1306_WIDTH - batteryWidth - 2; // top right corner (leave 2 pixel space from the edge)
    ...
    int batteryLevelWidth = 7; // let's say it's 70% now
