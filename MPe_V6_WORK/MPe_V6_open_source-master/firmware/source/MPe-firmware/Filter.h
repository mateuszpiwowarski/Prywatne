...
/*
 * Copyright Number Eight Innovation Limited
 * This file is part of MegunoLink library for Arduino https://github.com/Megunolink/MLP
 * It is licensed under GNU LESSER GENERAL PUBLIC LICENSE https://github.com/Megunolink/MLP/blob/master/LICENSE
